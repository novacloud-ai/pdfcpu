...
[![Test](https://github.com/novacloud-ai/pdfcpu/workflows/Test/badge.svg)](https://github.com/novacloud-ai/pdfcpu/actions)
...
[![GoDoc](https://godoc.org/github.com/novacloud-ai/pdfcpu?status.svg)](https://pkg.go.dev/github.com/novacloud-ai/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/novacloud-ai/pdfcpu)](https://goreportcard.com/report/github.com/novacloud-ai/pdfcpu)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/novacloud-ai/pdfcpu/releases)
...
* For API examples of all pdfcpu operations please refer to [GoDoc](https://pkg.go.dev/github.com/novacloud-ai/pdfcpu/pkg/api).

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/novacloud-ai/pdfcpu)
* [pdfcpu API](https://pkg.go.dev/github.com/novacloud-ai/pdfcpu/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/novacloud-ai/pdfcpu/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/novacloud-ai/pdfcpu/releases).


### Using Go Modules

```
$ git clone https://github.com/novacloud-ai/pdfcpu
...
```
$ go install github.com/novacloud-ai/pdfcpu/cmd/pdfcpu@latest
```
...
* Please [create](https://github.com/novacloud-ai/pdfcpu/issues/new/choose) an issue if you find a bug or want to propose a change.
* Feature requests - always welcome!
* Bug fixes - always welcome!
* PRs - let's [discuss](https://github.com/novacloud-ai/pdfcpu/discussions) first or [create](https://github.com/novacloud-ai/pdfcpu/issues/new/choose) an issue.
* pdfcpu is stable but still *Alpha* and occasionally undergoing heavy changes.

### How

* The pdfcpu [discussion board](https://github.com/novacloud-ai/pdfcpu/discussions) is open! Please engage in any form helpful for the community.
